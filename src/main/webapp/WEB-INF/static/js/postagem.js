...
function search(value) {
	...
	var clienteId = $('#table-ajax').attr('cpf');
	
	if (clienteId > 0) {
		url = "/blog/pedido/ajax/cliente/"+ clienteId + "/cpf/" + value + "/page/1";
	} else {
	    url = "/blog/pedido/ajax/cpf/" + value + "/page/1";
	}
...
function tbody(page) {
	...
	if (autorId > 0 && titulo.length > 0) {
		url = "/blog/pedido/ajax/cliente/"+ clienteId + "/cpf/" + cpf + "/page/" + page;
